...
export default function Categories() {
    ...
    const handleProductSelect = (name: any) => {
        router.push(`/categories?searchProduct=${name}`)
    };
    ...
    let searchProductName = url.searchParams.get("searchProduct");

    let productNameFilter = productName.filter((element: any) => {
        if (element.productName.includes(searchProductName ? searchProductName : "")) {
            return element
        }
    })
